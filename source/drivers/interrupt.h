...
#undef  VECTOR_084    //INTERRUPT_PIT0_IRQ + 16   //取消之前的定义
#define VECTOR_084  pit0_isr    //重新定义中断向量表中的PIT Channel 0所对应的中断服务函数的地址
//#undef  VECTOR_085    //INTERRUPT_PIT1_IRQ + 16   //取消之前的定义
//#define VECTOR_085  pit1_isr    //重新定义中断向量表中的PIT Channel 1所对应的中断服务函数的地址

/******************************************************
作者：黄伟波
日期：2014年1月22日
使用说明：需要用到的GPIO中断，请更改中断函数名后，将该部分中断、
          粘贴到interrupt.h并取消注释，中断向量对应的含义查阅vector.h
//GPIO模块中断服务定义
