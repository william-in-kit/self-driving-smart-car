...
#define CLR_FLAG_PIT1()  PIT_TFLG1 |= PIT_TFLG_TIF_MASK;
...
#define TIME0_GET()         (PIT_CVAL0 / 22) // depend on the bus frequency
                              ...
                              //exposuse time interrupt
#define TIME1_RESET()       {PIT_TCTRL1=0UL;PIT_TCTRL1=3UL;}
#define TIME1_GET()         (PIT_CVAL1 / 22)  // depend on the bus frequency
